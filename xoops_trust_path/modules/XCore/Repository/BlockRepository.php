...
class BlockRepository extends ObjectRepository
{
     ...
     * @return object Block reference to the new block
     **/
    ...
    /**
     * retrieve a specific {@link Block}
     *
     * @see Block
     * @param int $id bid of the block to retrieve
     * @return object Block reference to the block
     **/
    function &get($id)
    {
        $id = (int)$id;
     ...
     *
     * @param object Block $block reference to the block to insert
     * @param $autolink temp
     ...
     *
     * @param object Block $block reference to the block to delete
     * @return bool TRUE if succesful
     **/
    ...
    /**
     * retrieve array of {@link Block}s meeting certain conditions
     * @param object $criteria {@link CriteriaElement} with conditions for the blocks
     * @param bool $id_as_key should the blocks' bid be the key for the returned array?
     * @return array {@link Block}s matching the conditions
     **/
