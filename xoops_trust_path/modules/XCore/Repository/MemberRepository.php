...
class MemberRepository
{
    ...
    */
    ...
    {
        $this->_gHandler =new GroupRepository($db);
        $this->_uHandler =new UserRepository($db);
        $this->_mHandler =new MembershipRepository($db);
    }

    /**
     * create a new group
     *
     * @return object Group reference to the new group
     */
     ...
     * @return object Group reference to the group
     */
	...
	function &getUserByEmail($email)
	{
		...
		$myts =& TextSanitizer::getInstance();	///< @todo not depends
     ...
     * @return array array of {@link Group} objects
     */
     ...
     *
     * @param int $user_id ID of the user
     * @param bool $asobject return groups as {@link Group} objects or arrays?
