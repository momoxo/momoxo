...
class NotificationRepository extends ObjectRepository
{
	...
	function __construct(&$db)
	{
		...
		$this->mTrigger->register('NotificationRepository.Trigger');

		$this->mTriggerPreAction =new Delegate();
		$this->mTriggerPreAction->register("NotificationRepository.TriggerPreAction");
	}
    ...
    /**
     * Retrieve a {@link Notification}
     *
     * @param   int $id ID
     *
     * @return  object  {@link Notification}, FALSE on fail
     **/
    function &get($id)
    {
        $id = (int)$id;
    ...
    /**
     * Delete a {@link Notification} from the database
     *
     * @param   object  &$notification
     *
     * @return  bool
    ...
    /**
     * Get some {@link Notification}s
     *
     * @param   object  $criteria
     * @param   bool    $id_as_key  Use IDs as keys into the array?
     *
     * @return  array   Array of {@link Notification} objects
     **/
...
// TODO: is this a useful function?? (Copied from comment_handler)
    ...
    function triggerEvent ($category, $item_id, $event, $extra_tags=array(), $user_list=array(), $module_id=null, $omit_user_id=null)
    {
        ...
        // RaiseEvent 'NotificationRepository.Trigger' ('Xcore.Notify.Trigger')
...
// TODO: allow these to use current module, etc...
     ...
     * Update
     *
     * @param   object  &$notification  {@link Notification} object
