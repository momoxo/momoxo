...
class ConfigOptionRepository extends ObjectRepository
{
     ...
     * 
     * @return	object  reference to the {@link ConfigOption}, FALSE on fail
     */
    function &get($id)
    {
        $ret = false;
     ...
     * 
     * @param	object  &$confoption    reference to a {@link ConfigOption} 
