...
class ConfigRepository
{
    ...
    {
        $this->_cHandler =new ConfigItemRepository($db);
        $this->_oHandler =new ConfigOptionRepository($db);
    }
     ...
     * 
     * @see     ConfigItem
     * @return	object  reference to the new {@link ConfigItem}
     */
     ...
     * 
     * @param	object  &$config    reference to the {@link ConfigItem} 
     */
     ...
     * 
     * @param	object  &$config    reference to a {@link ConfigItem} 
     */
    ...
    /**
     * Make a new {@link ConfigOption} 
     * 
     * @return	object  {@link ConfigOption} 
     */
    ...
    /**
     * Get one or more {@link ConfigOption}s
     * 
     * @param	object  $criteria   {@link CriteriaElement} 
     * @param	bool    $id_as_key  Use IDs as keys in the array?
     * 
     * @return	array   Array of {@link ConfigOption}s
     */
    ...
    /**
     * Count some {@link ConfigOption}s
     * 
     * @param	object  $criteria   {@link CriteriaElement} 
     * 
     * @return	int     Count of {@link ConfigOption}s matching $criteria
     */
