...
class GroupPermRepository extends ObjectRepository
{

    /**
     * Create a new {@link GroupPerm} 
     * 
     ...
     * @param	int $id ID
     * 
     * @return	object  {@link GroupPerm}, FALSE on fail
     */
    function &get($id)
    {
        $ret = false;
    ...
    /**
     * Store a {@link GroupPerm} 
     * 
     * @param	object  &$perm  {@link GroupPerm} object
     * 
    ...
    /**
     * Retrieve multiple {@link GroupPerm}s 
     * 
     * @param	object  $criteria   {@link CriteriaElement}
     * @param	bool    $id_as_key  Use IDs as array keys?
     * 
     * @return	array   Array of {@link GroupPerm}s 
     */
