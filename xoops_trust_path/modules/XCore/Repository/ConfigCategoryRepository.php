...
class ConfigCategoryRepository extends ObjectRepository
{
     ...
     * 
     * @return	object  New {@link ConfigCategory} 
     */
    function &create($isNew = true)
    {
        $confcat =new ConfigCategory();
        if ($isNew) {
            $confcat->setNew();
        }
        return $confcat;
    ...
    /**
     * Retrieve a {@link ConfigCategory} 
     * 
     * @param	int $id ID
     * 
     * @return	object  {@link ConfigCategory}, FALSE on fail
     */
    function &get($id)
    {
        $ret = false;
    ...
    /**
     * Store a {@link ConfigCategory}
     * 
     * @param	object   &$confcat  {@link ConfigCategory}
     * 
    ...
    /**
     * Delelete a {@link ConfigCategory}
     * 
     * @param	object  &$confcat   {@link ConfigCategory}
     * 
     * @return	bool    TRUE on success
    ...
    /**
     * Get some {@link ConfigCategory}s
     * 
     * @param	object  $criteria   {@link CriteriaElement} 
     * @param	bool    $id_as_key  Use the IDs as keys to the array?
     * 
     * @return	array   Array of {@link ConfigCategory}s
     */
