...
define( '_MI_ALTSYS_ADMIN_IN_THEMEDSC' , '管理画面を表示するテーマ名を指定します。XOOPS 2.0.x 以外では有効になりません。また、mainfile.phpのcommon.php行直後に、<br />include XOOPS_TRUST_PATH.\'/modules/altsys/include/admin_in_theme.inc.php\';<br />の１行を挿入する必要があります' ) ;
