...
function altsys_include_language_file( $type )
{
	...
	} else if( file_exists( XOOPS_TRUST_PATH.'/modules/altsys/language/'.$mylang.'/'.$type.'.php' ) ) {
		include_once XOOPS_TRUST_PATH.'/modules/altsys/language/'.$mylang.'/'.$type.'.php' ;
	...
	} else if( file_exists( XOOPS_TRUST_PATH.'/modules/altsys/language/english/'.$type.'.php' ) ) {
		include_once XOOPS_TRUST_PATH.'/modules/altsys/language/english/'.$type.'.php' ;
	}
}
