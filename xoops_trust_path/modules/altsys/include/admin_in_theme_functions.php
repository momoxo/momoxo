...
/*	// include adminmenu
	...
	$xoopsTpl->assign( array(
		...
		'xoops_showlblock' => 1 ,
//		'xoops_js' => '//--></script><script type="text/javascript" src="'.XOOPS_URL.'/js/xoops.js"></script><script type="text/javascript" src="'.XOOPS_URL.'/include/layersmenu.js"></script><script type="text/javascript"><!--'."\n".$xoops_admin_menu_js ,
