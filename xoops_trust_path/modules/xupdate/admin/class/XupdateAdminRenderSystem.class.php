...
define('XUPDATE_ADMIN_RENDER_FALLBACK_PATH',XOOPS_MODULE_PATH . '/xcore/admin/theme');    // TODO will be use other path
define('XUPDATE_ADMIN_RENDER_FALLBACK_URL',XOOPS_MODULE_URL . '/xcore/admin/theme');    // TODO will be use other url

/**
 * Xupdate_AdminRenderSystem
**/
class Xupdate_AdminRenderSystem extends Xcore_AdminRenderSystem
{
    /**
     * prepare
     * 
    ...
    **/
    public function prepare(&$controller)
    {
        ...
        DelegateUtils::call('Xcore_RenderSystem.SetupXoopsTpl',new Ref($this->mSmarty));
