...
INSERT INTO `config` (`conf_id`, `conf_modid`, `conf_catid`, `conf_name`, `conf_title`, `conf_value`, `conf_desc`, `conf_formtype`, `conf_valuetype`, `conf_order`) VALUES (5,0,1,'server_TZ','_MD_AM_SERVERTZ','1','_MD_AM_SERVERTZDSC','timezone','float',8);
INSERT INTO `config` (`conf_id`, `conf_modid`, `conf_catid`, `conf_name`, `conf_title`, `conf_value`, `conf_desc`, `conf_formtype`, `conf_valuetype`, `conf_order`) VALUES (6,0,1,'default_TZ','_MD_AM_DEFAULTTZ','1','_MD_AM_DEFAULTTZDSC','timezone','float',10);
INSERT INTO `config` (`conf_id`, `conf_modid`, `conf_catid`, `conf_name`, `conf_title`, `conf_value`, `conf_desc`, `conf_formtype`, `conf_valuetype`, `conf_order`) VALUES (7,0,1,'theme_set','_MD_AM_DTHEME','momonga_basic','_MD_AM_DTHEMEDSC','theme','other',12);
...
INSERT INTO `config` (`conf_id`, `conf_modid`, `conf_catid`, `conf_name`, `conf_title`, `conf_value`, `conf_desc`, `conf_formtype`, `conf_valuetype`, `conf_order`) VALUES (30,0,1,'adminmail','_MD_AM_ADMINML','hamanaka.kazuhiro@gmail.com','_MD_AM_ADMINMLDSC','textbox','text',3);
...
INSERT INTO `config` (`conf_id`, `conf_modid`, `conf_catid`, `conf_name`, `conf_title`, `conf_value`, `conf_desc`, `conf_formtype`, `conf_valuetype`, `conf_order`) VALUES (72,0,1,'theme_set_allowed','_MD_AM_THEMEOK','a:3:{i:0;s:6:\"momonga_basic\";i:1;s:14:\"legacy_default\";i:2;s:16:\"pack2011_default\";}','_MD_AM_THEMEOKDSC','theme_multi','array',13);
...
INSERT INTO `config` (`conf_id`, `conf_modid`, `conf_catid`, `conf_name`, `conf_title`, `conf_value`, `conf_desc`, `conf_formtype`, `conf_valuetype`, `conf_order`) VALUES (75,0,3,'meta_description','_MI_XCORE_META_DESCRIPTION','Momonga XOOPS is a dynamic Object Oriented based open source portal script written in PHP.','_MI_XCORE_META_DESCRIPTION_DESC','textarea','text', 1);
...
INSERT INTO `config` (`conf_id`, `conf_modid`, `conf_catid`, `conf_name`, `conf_title`, `conf_value`, `conf_desc`, `conf_formtype`, `conf_valuetype`, `conf_order`) VALUES (80,0,3,'footer','_MI_XCORE_FOOTER','Powered by <a href=\"http://momonga-project.org/\" rel=\"external\">Momonga XOOPS</a> 2.2 &copy; 2001-2012 <a href=\"https://github.com/momonga-project/momonga/\" rel=\"external\">Momonga Project</a>','_MI_XCORE_FOOTER_DESC','textarea','text', 6);
