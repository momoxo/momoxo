...
**KARIMOJI** is a Simple, Secure and Scalable content management system and the package distribution of XOOPS Cube Project Team.
...
KARIMOJI source code which is one of base modules to ensure compatibility with old versions of Xoops 2 is released under a GPL licence.
...
Features
====
Below is a list of some of KARIMOJI features.
...
The source code of KARIMOJI is available on [Github](https://github.com/momonga-project/momonga)

KARIMOJI packages are available at [downloads](https://github.com/momonga-project/momonga/downloads) area.


Installation
====

KARIMOJI Installation Guide
...
### KARIMOJI_LEGALEGASystem Preferences
...
KARIMOJI API documentation generated by Apigen 2.7.0
...
KARIMOJI is open source project community driven. We encourage everyone in the community to contribute their knowledge and expertise.
Everyone in the community benefits from every [enhancement request](https://github.com/momonga-project/momonga/issues), submit [bug report](https://github.com/momonga-project/momonga/issues) and [patch](https://github.com/momonga-project/momonga/pulls) implemented to improve **Legacy**.
