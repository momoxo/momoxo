 ...
 */
class XcoreRender_TplfileEditForm extends XCube_ActionForm
{
	function getTokenName()
	{
		return "module.xcoreRender.TplfileEditForm.TOKEN." . $this->get('tpl_id');
	}
	...
	function prepare()
	{
		...
		$this->mFieldProperties['tpl_desc']->addMessage('maxlength', _AD_XCORERENDER_ERROR_MAXLENGTH, _AD_XCORERENDER_LANG_TPL_DESC, '255');
		...
		$this->mFieldProperties['tpl_source']->addMessage('required', _AD_XCORERENDER_ERROR_REQUIRED, _AD_XCORERENDER_LANG_TPL_SOURCE);
	}
