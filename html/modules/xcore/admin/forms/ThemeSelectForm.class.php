...
class Xcore_ThemeSelectForm extends ActionForm
{
	...
	function prepare()
	{
		...
		// Set form properties
		//
		$this->mFormProperties['select'] =new BoolArrayProperty('select');
		$this->mFormProperties['choose'] =new StringArrayProperty('choose');
	}
