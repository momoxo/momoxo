...
class XoopsErrorHandler
{
    ...
    function renderErrors()
    {
        ...
        if ($this->_isFatal) {
            ...
            $output .= 'If you are the administrator of this site, please visit the <a href="https://github.com/momonga-project/momonga/">XOOPS Cube Project Site</a> for assistance.<br/><br/>';
        }
