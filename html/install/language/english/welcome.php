...
"<u><b>What is it?</b></u>
<p>
<b>KARIMOJI</b> is a dynamic OO (Object Oriented) based open source portal script written in PHP.
XOOPS Cube supports a number of databases,
making KARIMOJI an ideal tool for developing small to large dynamic community websites,
intra company portals, corporate portals, weblogs and much more.
</p>
<p>
XOOPS Cube is released under the terms of the <a href='https://github.com/momonga-project/momonga/blob/master/docs/bsd_licenses.txt' rel='external'>New BSD License</a> and is free to use and modify.
It is free to redistribute as long as you abide by the distribution terms of the New BSD License.
</p>
<p>
KARIMOJI is released under the terms of the <a href='https://github.com/momonga-project/momonga/blob/master/docs/GPL_V2.txt' rel='external'>GNU General Public License (GPL)</a> and is free to use and modify.
...
<li>Prepare a database for your new KARIMOJI website.</li>
