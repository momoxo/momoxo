...
define('_MI_XCORERENDER_ADMENU_BANNER_MANAGE', "Gestion des Bannières");
define('_MI_XCORERENDER_ADMENU_TEMPLATE_MANAGE', "Gestion des Templates");
define('_MI_XCORERENDER_ADMENU_THEME_SETTING', "Paramètres Theme");
define('_MI_XCORERENDER_ADMENU_TPLFILE_MANAGE', "Fichiers Templates");
define('_MI_XCORERENDER_CONF_BANNERS', "Activer les bannières?");
define('_MI_XCORERENDER_NAME', "Legacy Renderer");
define('_MI_XCORERENDER_NAME_DESC', "Ce module de rendu (renderer) est compatible avec XOOPS 2.0.9 et XOOPS JP 2.0.x. Vous pouvez utiliser vos themes favoris de XOOPS2 avec ce système.");
