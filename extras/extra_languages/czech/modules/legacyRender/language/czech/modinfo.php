...
define('_MI_XCORERENDER_ADMENU_BANNER_MANAGE', "Spr�va baner�");
define('_MI_XCORERENDER_ADMENU_TEMPLATE_MANAGE', "Spr�va �ablon");
define('_MI_XCORERENDER_ADMENU_THEME_SETTING', "Nastaven� �ablon");
define('_MI_XCORERENDER_ADMENU_TPLFILE_MANAGE', "Soubory �ablon");
define('_MI_XCORERENDER_CONF_BANNERS', "Aktivovat reklamn� baner?");
define('_MI_XCORERENDER_NAME', "P�izp�soben�");
