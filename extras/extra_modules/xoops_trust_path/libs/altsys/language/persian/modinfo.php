...
define('_MI_ALTSYS_ADMIN_IN_THEMEDSC','این گزینه برای انتخاب قالب منوی مدیریت به کار میرود . خط زیر را باید به فایل mainfile.php اضافه کنید . درست بعد از خطی که برای شناساندن فایل common.php اضافه شده است .( include XOOPS_ROOT_PATH."/modules/xcore/include/common.php";) توجه داشته باشید در زبان فارسی ممکن است ظاهر منوی مدیریت اندکی به هم بریزد. <br /><br />include XOOPS_TRUST_PATH.\'/modules/altsys/include/admin_in_theme.inc.php\';	<br /><br />این قابلیت فقط در زوپس ۲.۰ و ایمپرس سی‌ام‌اس کار میکند');
