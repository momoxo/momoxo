...
define('_MI_XUPGRADE_DESC_INSTALLER_1', "このモジュールはあなたが XOOPS2 から KARIMOJI 2.1 にアップグレードすることを支援します。");
...
define('_MI_XUPGRADE_ERROR_PORTED_TEMPLATE', "'{1}' テンプレートセットの '{0}' ファイルを KARIMOJI_LEGALEGAへ移行できませんでした。");
...
define('_MI_XUPGRADE_MESSAGE_ADJUST_MODULE_ISACTIVE', "モジュール '{0}' の isactive 値を Cube KARIMOJI_LEGALEGA基準に修正しました。");
...
define('_MI_XUPGRADE_MESSAGE_PORTED_TEMPLATE', "'{1}' テンプレートセットの '{0}' ファイルを KARIMOJI_LEGALEGAへ移行しました。");
