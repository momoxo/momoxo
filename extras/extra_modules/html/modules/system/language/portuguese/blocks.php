...
define("_MB_SYSTEM_NODISPGR","N�o mostrar os associados cuja gradua��o �:");
define("_MB_SYSTEM_NOTIF","Notifica��es");
...
define("_MB_SYSTEM_SECURE","Entrar via conex�o segura");
define("_MB_SYSTEM_SEMTO","Enviar uma carta eletr�nica para %s");
define("_MB_SYSTEM_SPMTO","Enviar um recado para %s");
define("_MB_SYSTEM_SUBMS","Not�cias");
