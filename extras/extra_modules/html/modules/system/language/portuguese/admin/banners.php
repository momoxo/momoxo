...
define("_AM_IMPPURCHT","Impress�es contratadas:");
...
define("_AM_SUREDELE","Voc� tem certeza de que deseja remover este banner?");
define("_AM_NO","N�o");
define("_AM_YES","Sim");
define("_AM_EDITBNR","Editar banner");
define("_AM_ADDIMPT","Incluir impress�es:");
...
define("_AM_SUREDELCLI","Voc� est� prestes a remover o anunciante <b>%s</b> com todas as suas respectivas faixas publicit�rias.");
define("_AM_NOBNRRUN","Este anunciante n�o possui nenhum banner ativo.");
define("_AM_WARNING","ATEN��O.");
define("_AM_ACTBNRRUN","Este anunciante possui as seguintes faixas publicit�rias ativas:");
...
define("_AM_EXTINFO","Informa��es adicionais:");
